...
import { ArrowUpRight, Package, TrendingUp, AlertTriangle, BarChart3 } from "lucide-react"
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>Monthly inventory levels and sales trends</CardDescription>
            </CardHeader>
